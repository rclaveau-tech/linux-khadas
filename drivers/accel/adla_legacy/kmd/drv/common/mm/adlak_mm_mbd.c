...
static struct adlak_mem_mbd *ptr_mm_mbd;
/************************** Function Prototypes ******************************/
...
void adlak_mem_mbd_unregister(struct adlak_device *padlak,
...
int adlak_mem_mbd_register(struct adlak_device *padlak,
			   struct adlak_mem_operator *ops)
{
	int ret = 0;
	...
	if (!ptr_mm_mbd) {
		ptr_mm_mbd = adlak_os_zalloc(sizeof(struct adlak_mem_mbd),
					     ADLAK_GFP_KERNEL);
