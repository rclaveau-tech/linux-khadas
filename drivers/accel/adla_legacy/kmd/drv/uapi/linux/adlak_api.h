...
#define ADLAK_IOCTL_FREEBUF _IOWR(ADLAK_IOCTL_MAGIC, 2, u64)
...
#define ADLAK_IOCTL_DEBUG_MEM_COPY _IOW(ADLAK_IOCTL_MAGIC, 11, u64)

#define ADLAK_IOCTL_ATTACH_EXTERN_BUF _IOWR(ADLAK_IOCTL_MAGIC, 12, struct adlak_extern_buf_info)
#define ADLAK_IOCTL_DETTACH_EXTERN_BUF _IOW(ADLAK_IOCTL_MAGIC, 13, u64)
